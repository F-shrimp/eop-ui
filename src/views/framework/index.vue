         ...
         <el-row>
          <el-col :span="24">
            <el-form-item v-if="temp.rrflag" label="特殊项描述">
              ...
              <el-input v-show="this.isEdit" v-model="temp.on_special_content"></el-input>
            </el-form-item>
            <el-form-item v-else label="特殊项描述">
              <span class="grid-content bg-purple">{{ temp.off_special_content }}</span>
              <el-input v-show="this.isEdit" v-model="temp.off_special_content"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
